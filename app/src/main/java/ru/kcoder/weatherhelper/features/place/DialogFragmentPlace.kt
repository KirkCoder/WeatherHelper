...
class DialogFragmentPlace : DialogFragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        callback = when {
            ...
            else -> throw ClassCastException("Host fragment not implemented DialogFragmentPlace.Callback, for dialog result")
        }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() = DialogFragmentPlace()
    }
